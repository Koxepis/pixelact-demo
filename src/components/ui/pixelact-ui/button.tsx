...
const pixelButtonVariants = cva(
  "pixel__button pixel-font cursor-pointer rounded-none w-fit items-center justify-center whitespace-nowrap text-sm leading-[1.2] transition-colors transition-all duration-100",
  {
    variants: {
      variant: {
