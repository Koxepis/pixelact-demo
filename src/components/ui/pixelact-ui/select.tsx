  ...
  return (
    ...
    >
      <ShadcnSelectTrigger
        {...props}
        className={cn(
          "rounded-none bg-card dark:bg-card text-card-foreground ring-0 w-full border-0",
          className
        )}
      >
        {children}
...
function SelectContent({
  ...
  return (
    <ShadcnSelectContent
      className={cn(
        "relative bg-card text-card-foreground rounded-none border-none shadow-(--pixel-box-shadow) mt-2",
        inputVariants({ font }),
        className
      )}
      {...props}
